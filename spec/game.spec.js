...
function() {
    ...
    beforeEach(function() {
			...
			// 	        expect(TDD.typing.validate).toHaveBeenCalledWith(originalText, typedText);
			// 	    });


		it("should NOT end game when text is errornous", function() {
			var originalText = "Dette er en"
			var typedText = "D";
		...
		it("should end game when text is complete with no errors", function() {
			var originalText = "Dette er en"
